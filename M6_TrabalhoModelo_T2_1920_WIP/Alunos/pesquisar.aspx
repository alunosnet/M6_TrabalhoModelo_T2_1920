...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container">
            Nome: <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server"></asp:TextBox><asp:Button CssClass="btn btn-lg btn-info" ID="Button1" runat="server" Text="Pesquisar" />
